...
// can be utilized with different logging levels per backend and logger.
package logging
...
// (like passwords), which shouldn't be printed to the logging. The idea was found
...
var (
	// Sequence number is incremented and utilized for all logging records created.
	sequenceNo uint64
...
// Record represents a logging record and contains the timestamp when the record
// was created, an increasing id, filename and line and finally the actual
// formatted logging line.
type Record struct {
	Id     uint64
	Time   time.Time
	Module string
...
// Formatted returns the formatted logging record string.
...
// Message returns the logging record message.
...
// Logger is the actual logger which creates logging records based on the functions
...
// Critical logs a message using CRITICAL as logging level.
func (l *Logger) Critical(format string, args ...interface{}) {
	l.log(CRITICAL, format, args...)
}

// Error logs a message using ERROR as logging level.
func (l *Logger) Error(format string, args ...interface{}) {
	l.log(ERROR, format, args...)
}

// Errorf logs a message using ERROR as logging level.
func (l *Logger) Errorf(format string, args ...interface{}) {
	l.log(ERROR, format, args...)
}

// Warning logs a message using WARNING as logging level.
func (l *Logger) Warning(format string, args ...interface{}) {
	l.log(WARNING, format, args...)
}

// Warningf logs a message using WARNING as logging level.
func (l *Logger) Warningf(format string, args ...interface{}) {
	l.log(WARNING, format, args...)
}

// Notice logs a message using NOTICE as logging level.
func (l *Logger) Notice(format string, args ...interface{}) {
	l.log(NOTICE, format, args...)
}

// Noticef logs a message using NOTICE as logging level.
func (l *Logger) Noticef(format string, args ...interface{}) {
	l.log(NOTICE, format, args...)
}

// Info logs a message using INFO as logging level.
func (l *Logger) Info(format string, args ...interface{}) {
	l.log(INFO, format, args...)
}

// Infof logs a message using INFO as logging level.
func (l *Logger) Infof(format string, args ...interface{}) {
	l.log(INFO, format, args...)
}

// Debug logs a message using DEBUG as logging level.
func (l *Logger) Debug(format string, args ...interface{}) {
	l.log(DEBUG, format, args...)
}

// Debugf logs a message using DEBUG as logging level.
